        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <a href="/createUser" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                        <i class="fas fa-download fa-sm text-white-50"></i> Stwórz użytkownika
                    </a>
                        ...
                        <table class="table">
                            ...
                            <c:forEach var="user" items="${users}">
                                <tr>
                                    ...
                                    <td>${user.email}</td>
                                    <td>
                                        <a href="/deleteUser?id=${user.id}">Usuń</a> |
